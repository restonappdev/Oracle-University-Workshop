...
## Introduction
This lab will dive into the details of development of the bot. We will learn about Intent & Entity feature of Bots, create instant app for login, set up Backends & APIs for bot and lastly add dialog flows, this will make Gen University Bot more interactive.

## Objectives
- Learn about Intent & Entities feature of AMCes
- Add an instant app of login to the bot interaction
- Set Up Mobile Backend & APIs for bot
- Create & Configure backend service for the chatbot
...
- While intents map words and phrases to a specific action, entities add context to the intent itself. They help to describe the intent more fully and enable your bot to complete a user request. The Location intent, for example, describes a user request, but only in general terms.

![](./images/200/2.png)

### Step 2: Add an instant app of login to the bot interaction
...
- This will take you to a dashboard for Instant Apps. Here, we will click on **New Instant App**. 

![](./images/200/5.png)

- As you can see, there are many templates you can choose from to help you build an instant app. For today, we will import a pre-built one. Click on **Import an Instant App** on the top left of the screen and drag and drop **HCM-Login-Tests.json** from the folder you have cloned from github. 
...
### Step 3: Set Up Mobile Backend & APIs for bot
- Now, Intents, Entities, and Instant app are ready, we need to create bot Backend & its API services which are supported in our AMCe. In order to get or update a student's basic information e.g. email, address, phone. We need to develop a backend service which can get or make the update real-time with Oracle HCM.
...
- You will see dashboard for the new backend which you just created.
![](./images/200/12.png)

- Click **APIs** in the left panel, then click **+ New API**.

![](./images/200/13.png)

- Enter the following information in the prompt:
  - API Display Name: `universityservice`
  - API Name: `universityservice`
  - Short Description: anything you like

- Click on **Create** button, it will pop-up a tour, you can watch the video or click **Got it**.  
...
- Click **Implementation** in the left panel, then click **Upload an implementation archive** and upload **University_Workshop_components.zip** file.

![](./images/200/17.png)

![](./images/200/18.png)

- Once you upload that zip file successfully, then click **Save**
...
- Now, we can test your API and see whether it is working or not.
...
- Go back to **Backends** by clicking hamburger menu button on top left corner of the screen
![](./images/200/28.png)

- Double clicking **UniversityWorkshop_Backend1.0**, it will forward to its setting page
![](./images/200/29.png)
...
### Step 4: Create & Configure backend service for the chatbot
...
- Fill all required information, paste **backend ID**, **anonymous key** and **metadata url** from above copied, then you will get successful message.
![](./images/200/32.png)
...
### Step 5: Add interactive dialog flow code
